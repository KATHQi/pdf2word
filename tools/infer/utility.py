...
def create_predictor(args, mode, logger):
    if mode == "det":
        ...
        model_dir = r'/data/tensorflow/kath/Service/pdf2word/models/ch_PP-OCRv3_det_infer'
    elif mode == 'cls':

        model_dir = args.cls_model_dir
    elif mode == 'rec':
        model_dir = r'/data/tensorflow/kath/Service/pdf2word/models/ch_PP-OCRv3_rec_infer'
        # model_dir = args.rec_model_dir
    elif mode == 'table':
        # model_dir = r'/data/tensorflow/kath/Service/pdf2word/models/cn_ppstructure_mobile_v2.0_SLANet_infer'
        model_dir = r'/data/tensorflow/kath/Service/pdf2word/PaddleOCR-release-2.7/inference/table_new'
        ...
        model_dir = r'/data/tensorflow/kath/Service/pdf2word/models/picodet_lcnet_x1_0_fgd_layout_cdla_infer'
    else:
    ...
    if args.use_onnx:
        ...
        print('[config - from tools/infer/utility.py] ',config )
...
def draw_boxes2(image, boxes, scores=None, drop_score=0.5,color=(255, 0, 0)):
    if scores is None:
        scores = [1] * len(boxes)
    for (box, score) in zip(boxes, scores):
        if score < drop_score:
